...
export const propertyCreateValidation = Yup.object({
  ...
  instrumentNumber: Yup.string().matches(/^[0-9]+$/, "general.only_num").min(12 , "errors.password_tweleve").max(12 , "errors.password_tweleve").required("errors.instrumentNumber"),
